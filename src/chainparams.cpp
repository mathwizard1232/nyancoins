...
static Checkpoints::MapCheckpoints mapCheckpoints =
        ...
        ;
static const Checkpoints::CCheckpointData data = { // TODO Update the below for Nyancoins 2.0!!
        &mapCheckpoints,
...
// Make up a checkpoint for nyancoins testnet?
...
public:
    CMainParams() {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 3 * 60 * 60; // NyanCoin: 3 hours
        nTargetSpacing = 60; // NyanCoin: 1 minute blocks
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1388708431;
        genesis.nBits    = 0x1e0ffff0;
        genesis.nNonce   = 183531;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0xb477d9bc0721a1b96547495404583d68123f471fdd1d4058a9adff2fa7452298"));
        //assert(genesis.hashMerkleRoot == uint256("0x97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9"));

        vSeeds.push_back(CDNSSeedData("nyanseed.com", "nyanseed.com")); // Original Nyancoins 1.2 seed; we should add more freely;
        // also, use prefixes like dnsseed per nyancoin / testnet-seed

        base58Prefixes[PUBKEY_ADDRESS] = list_of(45); // Magic number per Nyancoins 1.2
        ...
        // Nyancoin2: remove references to this; do not fork from NYAN1.2
...
public:
    CTestNetParams() {
        ...
        genesis.nTime = 1388706745;
        genesis.nNonce = 84274;
        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0xe81767842ce87c4f36be66b618129a8bed08a805f705c6dac689df2350926111"));
        ...
        // Nyancoin2: WE NEED TO REMOVE THIS LOGIC WHEREVER IT IS REFERENCED; NO FORK FROM NYAN1.2
        nEnforceV2AfterHeight = -1;
    }
    const Checkpoints::CCheckpointData& Checkpoints() const 
    {
...
public:
    CRegTestParams() {
        ...
        // Nyancoin: NEED TO TRACK DOWN AND REMOVE LOGIC REFERENCING THIS; DO NOT FORK FROM NYAN 1.2 WHICH DID NOT HAVE THIS
        nEnforceV2AfterHeight = -1;
    }
    const Checkpoints::CCheckpointData& Checkpoints() const 
    {
...
public:
    CUnitTestParams() {
        ...
        // Litecoin: v2 enforced using Bitcoin's supermajority rule
        // Nyancoin2: remove this logic where referenced
        nEnforceV2AfterHeight = -1;
    }
